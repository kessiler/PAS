            ...
            elseif (isset($_POST['confirmarsaida'])):
                ...
                <div class="form_settings">
                    <form id="SaidaAtivos" method="post" action="">
                        ...
                        <p><span>Quantidade de Saída</span><input class="validate[required] text-input" type="text" name="nome" value=""/></p>
                        <input class="submit" type="submit" style="width: 120px; margin: 10px 0 0 190px;" name="confirmarsaida" value="Confirmar saída"/>
                    </form>
                </div>
                <? endif; ?>
        </div>
